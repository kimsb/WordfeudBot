...
import wordfeudapi.util.wordfeudapi.exception.WordFeudException;
import wordfeudapi.util.wordfeudapi.exception.WordFeudLoginRequiredException;
import wordfeudapi.util.wordfeudapi.http.ApacheHttpClientCommunicator;
import wordfeudapi.util.wordfeudapi.http.HttpCommunicator;
import wordfeudapi.util.wordfeudapi.util.SHA1;
